...
HALLUCINATION_PATTERNS = [
    ...
    (r"Thu Di.*(giấu con|cho di ăn|con đi cùng Di|di định đợi)|di giấu con|cho di ăn lót dạ", "Tiêu Phùng (18 tuổi) và Bạch Thu Lâm (24 tuổi) chênh lệch 6 tuổi, quan hệ là TỶ - ĐỆ (xưng Thu Di / Tỷ — Đệ). Tuyệt đối KHÔNG xưng Di - con phi logic sinh học!"),
